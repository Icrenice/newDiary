    ...
    <div class="row content">
      <div class="col-sm-3 col-sm-3-1">
        <ul class="nav nav-pills flex-column">
          <li class="nav-item">
            <a class="nav-link active1" href="maakverhaal.php">Schrijf je Verhaal</a>
          </li>
          <li class="nav-item">
      ...
      <div class="col-sm-9 text-left">
        <h1>Schrijf hier jouw verhaal aan.</h1>
        <form method="post" action="forms/verhaal.php">
          <textarea name="posts" rows="19" cols="30"> </textarea>
          <?php
          ...
          if (empty($diaries_data)) {
            echo "u moet nog dagboeken aanmaken";
          } else { ?>
            <select type="select" name="dagboekid" required>

              <?php foreach ($diaries_data as $diary_data) { ?>


                <option value=" <?php echo $diary_data['id_dagboek']; ?>">
                  <?php echo $diary_data['naam']; ?>
                </option>
            ...
            <div class="flex2">
              <button type="submit" class="btn btn-outline-secondary">Opslaan</button>
            </div>
        </form>
