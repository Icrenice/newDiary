        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav">
                <li class="nav-item active">
                    <a class="nav-link" href="MijnPersoonlijkeDagboek.php">Thuis <span class="sr-only">(current)</span></a>
                </li>
            </ul>
    ...
    <div class="login-form">
        ...
        <div class="container">
            ...
            <form class="form-login" method="post" id="login-form" action="forms/login-form.php">
                ...
                <div class="form-group">
                    <button type="submit" name="submit" class="btn btn-outline-secondary">Login</button>
                </div>
                <br>
