    ...
    <div class="row content">
      <div class="col-sm-3 col-sm-3-1">
        <ul class="nav nav-pills flex-column">
          ...
          <li class="nav-item">
            <a class="nav-link active1" href="maakdagboek.php">Maak dagboek</a>
          </li>
          <li class="nav-item">
      ...
      <div class="col-sm-9 text-left">
        <h1>Maak hier dagboek aan.</h1>

        <form method="post" action="forms/dagboek.php">
          <div class="form-group">
            <label>Dagboek Naam:</label>
            <input type="text" class="form-control" name="titel" placeholder="Dagboek Naam:" required />
          </div>

          <div class="flex2">
            <button type="submit" name="btn-login" class="btn btn-outline-secondary">Opslaan</button>
          </div>
        </form>
